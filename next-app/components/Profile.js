		...
		<>
			<div className="profile-box">
				...
				<p className="profile-user-info">
					...
					<span className="profile-user-info-text">paper company</span>
				</p>
				<p className="profile-user-info">
					<GoLocation size={16} color="#6a737d" />
					<span className="profile-user-info-text">Seoul</span>
				</p>
				<p className="profile-user-info">
					<GoMail size={16} color="#6a737d" />
					<span className="profile-user-info-text">leekh716@naver.com</span>
				</p>
				<p className="profile-user-info">
					<GoLink size={16} color="#6a737d" />
					<span className="profile-user-info-text">kunlee's blog</span>
				</p>
			</div>
